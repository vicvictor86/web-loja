"""
Django settings for lojaparatudo project.
...
SECRET_KEY = 'django-insecure-t2b%f*%716uxmqe5bi$9i#9vg!r=iiq(35percp&pgen#@r_js'
...
WSGI_APPLICATION = 'lojaparatudo.wsgi.application'
